...
//TODO: change evry spanish name to english, in new repository
...
require_login (); 
//set context and layout
$baseurl = new moodle_url ( '/local/reservasalas/reserve/reserve.php' ); 
...
$PAGE->navbar->add ( get_string ( 'reserverooms', 'local_reservasalas' ), 'reserve.php' );
echo $OUTPUT->header (); 
echo $OUTPUT->heading ( get_string ( 'reserveroom', 'local_reservasalas' ) );

$search_room_form = new formSearchRoom ( null );
echo $search_room_form->display ();

if ($fromform = $search_room_form->get_data ()) {	
